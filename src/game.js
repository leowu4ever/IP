...
var platforms = ["floating", "wide", "normal", "tall"]
var items = ["diamond", "enemy", "player", "star"]
...
Game = {
  start: function() {
    ...
    // normal
    spawn (platform_normal_x, platform_normal_y, "platform_normal")
    spawn (platform_normal_x + 70, platform_normal_y - 30, "star")

    // floating
    spawn (platform_floating_x, platform_floating_y, "platform_floating")
    spawn (platform_floating_x + 40, platform_floating_y - 30, "diamond")

    // high
    spawn (platform_high_x, platform_high_y, "platform_high")
    spawn (platform_high_x + 20, platform_high_y - 30, "player")

    // wide + wood + grass + character_2 + cloud
    spawn (platform_wide_x, platform_wide_y, "platform_wide")
    spawn (platform_wide_x + 40, platform_wide_y - 34, "character_2")
...
function spawn(_x, _y, name) { return Crafty.e("2D, DOM, Image").attr({x: _x, y: _y}).image("assets/" + name + ".png") }
